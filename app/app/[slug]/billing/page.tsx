      ...
      <header className="max-w-6xl mx-auto space-y-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
          <div className="space-y-1">
            <h1 className="text-4xl font-extrabold tracking-tight text-foreground text-transparent bg-clip-text bg-gradient-to-r from-foreground to-foreground/60">
              Choose Your Plan
            </h1>
          ...
          <div className="flex gap-2">
            <Badge
              variant="secondary"
              className="bg-primary/5 text-primary border-none px-4 py-1.5 font-bold flex gap-2 items-center"
            >
              <CreditCard size={14} />
      ...
      <main className="max-w-6xl mx-auto space-y-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {PLANS.map((plan) => (
            <Card
              key={plan.name}
              className={`relative p-10 flex flex-col rounded-[2.5rem] border-border/40 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 ${
                plan.popular
            ...
            >
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-baseline gap-1">
                  ...
                  {plan.period && (
                    <span className="text-mutedForeground font-bold text-lg">
                      {plan.period}
                    </span>
                  )}
                </div>
              ...
              <div className="space-y-4 mb-10 flex-1">
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-mutedForeground">
                  What&apos;s Included
                </p>
              ...
              <Button
                ...
                className={`w-full h-14 rounded-2xl font-black text-sm tracking-wide transition-all ${
                  plan.popular
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pt-12 border-t border-border/40">
          <div className="space-y-4">
            ...
            <p className="text-xs text-mutedForeground leading-relaxed">
              All transactions are protected by 256-bit SSL encryption and
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-mutedForeground leading-relaxed">
              Upgraded features are available immediately across all your
              devices once payment is confirmed.
            </p>
          </div>
          <div className="space-y-4">
            <div className="flex items-center gap-3 text-primary">
