            ...
            <header className="max-w-5xl mx-auto space-y-4">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                    <div className="space-y-1">
                        <h1 className="text-4xl font-extrabold tracking-tight text-foreground">Activity Log</h1>
                        <p className="text-mutedForeground text-lg font-medium">
                            Real-time stream of all actions in <span className="text-foreground font-bold">{slug}</span>.
                        </p>
                    </div>
                    <div className="flex gap-2">
                        <Button variant="secondary" className="rounded-xl font-bold gap-2 bg-card border-border/50">
                            <Calendar size={16} />
                            <span>All Time</span>
                        </Button>
                        <Button variant="secondary" className="rounded-xl font-bold gap-2 bg-card border-border/50">
                        ...
                        {activities.length > 0 ? (
                            ...
                            <div className="py-24 flex flex-col items-center justify-center text-center space-y-6 opacity-40">
                                ...
                                <div className="space-y-2">
                                    <h3 className="text-2xl font-black text-foreground">No activities recorded</h3>
                                    <p className="text-mutedForeground max-w-sm mx-auto">
                                        Events will appear here as team members create tasks, update projects, and track time.
                                    </p>
                                </div>
                            </div>
                        )}
