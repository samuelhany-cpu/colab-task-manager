...
export async function GET(
    ...
    try {
        ...
        const totalHours = timeEntries.reduce((acc, curr) => acc + curr.duration / 3600, 0);
        ...
        return NextResponse.json({
            ...
            recentActivity: activities.map((a) => ({
                ...
                action: a.type === "CREATED" ? "created task" :
                    a.type === "STATUS_CHANGE" ? "updated status of" :
                        a.type === "COMMENT_ADDED" ? "commented on" : "modified",
                target: a.task.title,
